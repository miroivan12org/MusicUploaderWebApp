var MusiUploaderWeb = MusiUploaderWeb || {};

MusiUploaderWeb.createNameSpace = function (namespace) {

    //get the namespace string and split it
    var namespaceArr = namespace.split('.');
    var parent = MusiUploaderWeb;

    // excluding the parent
    if (namespaceArr[0] === 'MusiUploaderWeb') {
...
MusiUploaderWeb.createNameSpace("MusiUploaderWeb.Cookies");

MusiUploaderWeb.Cookies.getCookie = function (ck_name) {
...
MusiUploaderWeb.Cookies.setCookie = function (ck_name, value, exdays) {
    var exdate = new Date();
